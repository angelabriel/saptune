...
func checkUpdateLeftOvers() {
	...
	if system.CheckForPattern("/etc/tuned/saptune/tuned.conf", "#stv1tov2#") {
		...
		log.Println("         For more information refer to the man page saptune-migration(5)")
	}
